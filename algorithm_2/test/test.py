...
import sys
sys.path.append('..')
from algorithm import level_ground, distance_between_pairs
...
class Test(unittest.TestCase):
    ...
    def shortest_path(self):
        ...
        shortest_dig_dump_pairs, _ = distance_between_pairs(all_pairs_all_digs[0], all_pairs_all_digs[1])
        self.assertIsNotNone(shortest_dig_dump_pairs)
        for dig_dump_pairs in all_pairs_all_digs[2:]:
            shortest_dig_dump_pairs, _ = distance_between_pairs(shortest_dig_dump_pairs, dig_dump_pairs)
            self.assertIsNotNone(shortest_dig_dump_pairs)

        print(shortest_dig_dump_pairs, '\n', self.dig_dump_pairs)
        shortest_dig_dump_pairs, _ = distance_between_pairs(self.dig_dump_pairs, shortest_dig_dump_pairs)
